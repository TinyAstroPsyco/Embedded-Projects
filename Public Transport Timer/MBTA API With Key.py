...
if response.status_code == 200:
    ...
    # print(f'The rate limit you have >> {x_ratelimit_limit}')
...
for i in range(4):
    ...
    time = time_stamp.split("T")
    print(f'Time >> {time[-1]}')

with open("prediction_data_with Key.json","w") as file:
